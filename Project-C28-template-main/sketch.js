...
function setup() {
  ...
  mango2=new mango(1170,130,30);
	...
	mango8=new mango(960,150,40);
	mango9=new mango(1160,230,40);
	mango10=new mango(1190,200,40);
	mango11=new mango(1120,50,40);
	mango12=new mango(1120,160,40);
  mango13=new mango(980,120,40);
  mango14=new mango(1190,130,40);
  mango15=new mango(1140,135,40);
  mango16=new mango(1160,136,40);
  mango17=new mango(900,128,40);
  mango18=new mango(1170,124,40);
  mango19=new mango(1140,225,40);
  mango20=new mango(900,220,40);
